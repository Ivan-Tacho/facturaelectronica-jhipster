package com.facturaelectronica.app.config;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeRequests()
                ...
                .antMatchers("/api/usuarios/existe-usuario/**").permitAll()
                ...
                .antMatchers("/").permitAll()
                // Permitir acceso a los recursos estáticos sin autenticación
                .antMatchers("/css/**", "/js/**", "/images/**").permitAll()
                // Restringir acceso a otras rutas
